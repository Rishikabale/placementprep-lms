...
export default function EditQuizPage({ params }: { params: Promise<{ quizId: string }> }) {
    ...
    const courseId = searchParams.get('courseId'); // To navigate back
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex justify-end gap-3">
                    <button
                        type="button"
                        onClick={() => router.back()}
                        className="bg-gray-200 text-gray-700 px-6 py-3 rounded-md shadow-sm hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 text-lg font-medium"
                    >
                        Cancel
                    </button>
                    <button
