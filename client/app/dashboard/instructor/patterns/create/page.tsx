...
export default function CreatePatternPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push('/dashboard/instructor/patterns');
        } catch (error) {
            console.error(error);
    ...
    return (
        <div className="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-8">Create New Company Pattern</h1>
                    ...
                    <div className="flex items-center space-x-4 mt-4">
                        <div className="flex items-center">
                            <input
                                ...
                                className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
                            />
                            <label className="ml-2 block text-sm font-medium text-indigo-700">Share with Community (Public)</label>
                        </div>
                    </div>
                </div>
