...
const seed = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const admin = yield User_1.default.create({ name: 'Admin User', email: 'admin@example.com', password, role: 'admin' });
        const instructor = yield User_1.default.create({ name: 'Instructor User', email: 'instructor@example.com', password, role: 'instructor' });
        const student = yield User_1.default.create({ name: 'Student User', email: 'student@example.com', password, role: 'student' });
        ...
        const videoQ1 = yield Question_1.default.create({
        ...
        // Create Video Quiz
        const videoQuiz = yield Quiz_1.default.create({
            title: 'Binary Search Quiz',
            questions: [videoQ1._id],
            type: 'VIDEO_QUIZ'
        });
        // Create Video
        ...
        course.modules[0].videos.push(video._id);
        yield course.save();
        // Link Quiz to Video
        videoQuiz.relatedVideo = video._id;
        yield videoQuiz.save();
        console.log('Video & Quiz Created');
        // Create Aptitude Test
        const aptQ1 = yield Question_1.default.create({
        ...
        const aptitudeTest = yield Quiz_1.default.create({
        ...
        const rlCourse = yield Course_1.default.create({
        ...
        // Create RL Video
        const rlVideoQ1 = yield Question_1.default.create({
        ...
        const rlVideoQuiz = yield Quiz_1.default.create({
            title: 'RL Basics Quiz',
            questions: [rlVideoQ1._id],
            type: 'VIDEO_QUIZ'
        });
        const rlVideo = yield Video_1.default.create({
            title: 'What is Reinforcement Learning?',
            description: 'Understanding Agents, Environments, and Rewards.',
            url: 'https://www.w3schools.com/html/mov_bbb.mp4', // Placeholder
            duration: 800,
            courseId: rlCourse._id,
            quizId: rlVideoQuiz._id
        });
        rlCourse.modules[0].videos.push(rlVideo._id);
        yield rlCourse.save();
        rlVideoQuiz.relatedVideo = rlVideo._id;
        yield rlVideoQuiz.save();
        console.log('RL Course Created');
        // Create Company Patterns
        const CompanyPattern = require('./models/CompanyPattern').default;
        const tcsPattern = yield CompanyPattern.create({
        ...
        const accenturePattern = yield CompanyPattern.create({
            name: 'Accenture Mock',
        ...
        const frontendDev = yield CareerRole.create({
        ...
        const dataAnalyst = yield CareerRole.create({
