...
const CareerRecommendationSchema = new mongoose_1.Schema({
    ...
    recommendations: [{
            role: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'CareerRole' },
...
exports.default = mongoose_1.default.model('CareerRecommendation', CareerRecommendationSchema);
